        ...
        <div class="rs-carousel owl-carousel dot-style1"
            ...
            ?>
                <div class="team-wrap">
                    <div class="team-image">
                        <img src="admin/uploads/products/<?= $row['image1'] ?>" alt="Team Image">
                    </div>
                    <div class="text-bottom">
                        <h4 class="person-name">
                            <a href="team-single.php?id=<?= $row['id'] ?>"><?= $row['name'] ?></a>
                        </h4>
                        <span class="designation"><?= $row['post'] ?></span>
                        <div class="social-links">
                            <ul>
                                <li><a href="<?= $row['link'] ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="<?= $row['link1'] ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
                                <li><a href="<?= $row['link2'] ?>" target="_blank"><i class="fa fa-twitter"></i></a></li>
                                <li><a href="<?= $row['link3'] ?>" target="_blank"><i class="fa fa-youtube"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            <?php } ?>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">Francis Ibikunle</a></h4>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">Ara Gates</a></h4>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">Claire Divas</a></h4>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">Isabella Croline</a></h4>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">John Masud</a></h4>
                                <span class="designation">Senior Consultant</span>
                                <div class="social-links">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">John Freight</a></h4>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">John Maliha</a></h4>
                                <span class="designation">Business Advisor</span>
                                <div class="social-links">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <!-- <div class="team-wrap">
                            ...
                            <div class="text-bottom">
                                <h4 class="person-name"><a href="team-single.html">Mike Jason</a></h4>
                                <span class="designation">Business Advisor</span>
                                <div class="social-links">
                                    <ul>
                                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
